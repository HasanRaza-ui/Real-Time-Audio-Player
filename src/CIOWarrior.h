 ...
 *
 * After you have fully defined and implemented the CIOWarrior class and built the project without errors,
 * please comment out the following line:
 *
 * #undef CIOW_COMPLETE
 *
 * ... and build the project once more. If there are build errors now, check if you really declared
 * CIOWarrior according to the specifications of the class diagram (misspellings? wrong parameter types?
 * forgotten methods? ...)
 */
